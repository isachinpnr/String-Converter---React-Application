    ...
    <>
      <nav className="navbar navbar-expand-lg bg-body-tertiary ">
        <div className={`container-fluid bg-${props.mode === 'light' ? 'white' : 'black'}`}>
          <a className="navbar-brand " href="/" style={{ color: props.mode === 'light' ? 'black' : 'white' }}>Textutils</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <a className="nav-link active " aria-current="page " href="/" style={{ color: props.mode === 'light' ? 'black' : 'white' }}>About </a>
              </li>
              <li className="nav-item">
                <a className="nav-link " href="/" style={{ color: props.mode === 'light' ? 'black' : 'white' }}>Contact </a>
              </li>
