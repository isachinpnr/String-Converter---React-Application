  ...
  return (
    <>
      ...
      <div className="container my-5" style={{ myStyle }}>
        <h1 style={{ myStyle }}>{props.aboutme}</h1>
          ...
          <div class="accordion-item" style={{ myStyle }}>
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <strong>This is the first item's accordion body.</strong> It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as <code>well</code> as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
              </div>
            </div>
          </div>
          <div class="accordion-item" style={{ myStyle }}>
        ...
        {/* <button className='btn btn-primary my-2' onClick={props.screenMode}>{props.aboutBtn}</button> */}
      </div>
